...
export default function Navbar() {
    ...
    return (
        <nav
            role="navigation"
            className={` fixed m-auto w-fit pl-6 pr-6 transition-all duration-500 ease-out-in text-dark dark:text-light ${isMorphed ? "top-0 left-0 right-0 h-16 flex items-center justify-center" : "card-glass top-1/2 left-0 right-0 transform -translate-y-1/2 h-24 absolute flex items-center justify-center text-4xl"}`}
        >
